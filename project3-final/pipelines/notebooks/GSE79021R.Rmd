...
```{r, message=FALSE, warning=FALSE}
# =====================================================
# Combine all samples into wide dataframe
# =====================================================
...
```{r, message=FALSE, warning=FALSE}
# =====================================================
# Subset dataset by tissue type and BMI
# =====================================================
...
data.frame(
  dataset = c("dftumor_np", "dftumor_ob", "dfnormal_np", "dfnormal_ob"),
  samples = c(
    nrow(dftumor_np),
    nrow(dftumor_ob),
    nrow(dfnormal_np),
...
```{r, message=FALSE, warning=FALSE}
# =====================================================
# Calculate DEGs and generate volcano plots
# =====================================================
...
```{r, message=FALSE, warning=FALSE}
# =====================================================
# Generate interactive volcano plots
# =====================================================
...
# =====================================================
# --- Global thresholds used across plots/exports ---
fc_thresh_color <- 0.30103   # |log2FC| >= 0.3
p_thresh_color  <- 0.05      # p < 0.05
p_thresh_line   <- -log10(p_thresh_color)  # ≈ 1.301 (visual guide line)
...
export_deg_sets <- function(deg_obj, tag, top_n = 300){
  ...
  # STRING lists
  writeLines(head(up$gene,   top_n), paste0("../../data/interim/STRING_genes_UP_",   tag, ".txt"))
  writeLines(head(down$gene, top_n), paste0("../../data/interim/STRING_genes_DOWN_", tag, ".txt"))
  ...
  readr::write_csv(nodes, paste0("../../data/interim/NODES_for_Cytoscape_", tag, ".csv"))
